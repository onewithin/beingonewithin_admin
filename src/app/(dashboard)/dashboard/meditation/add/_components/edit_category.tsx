...
import { ImagePlus, Edit, X } from 'lucide-react'
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="sm:max-w-[520px] p-0 overflow-hidden rounded-2xl">
                    <DialogHeader className="px-6 pt-6 pb-4 border-b border-gray-100">
                        <DialogTitle className="text-lg font-semibold text-gray-900 font-rubik-400">Edit Category</DialogTitle>
                        <p className="text-sm text-gray-500 font-rubik-400 mt-0.5">Update the category details below.</p>
                    </DialogHeader>
